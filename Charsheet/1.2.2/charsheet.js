...
on("chat:message", function(msg) {
    ...
    if (msg.content.indexOf('!charsheet') != -1) {
        ...
        var charName = msg.content.replace('!charsheet ', '');
        Charsheet.Generate(msg, charName);
    }
});

Charsheet.Generate = function(msg, characterName) {
        ...
        var template = {
          ...
          "charactername": characterName // use character name from the message content which should be replaced on line 17
        }
