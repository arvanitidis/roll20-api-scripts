...
on("chat:message", function(msg) {
    ...
    if (msg.content.indexOf('!charsheet') != -1) {
        // replace the !chatsheet command with nothing, leaving just the character name behind
        msg.content.replace('!charsheet ', '');
...
Charsheet.Generate = function(msg) {
        ...
        var template = {
          ...
          "charactername": msg.content // use character name from the message content which should be replaced on line 17
        }
